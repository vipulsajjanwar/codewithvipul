    ...
    <section id="about" className="relative min-h-screen pb-24 pt-32 md:pt-40">
      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-6 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h2 className="mt-4 text-xl font-medium text-primary md:text-2xl">
          ...
          <nav className="mt-12 flex flex-col gap-4">
            {[
              ...
              <Link
                key={link.href}
                href={link.href}
                className="group flex items-center gap-4 text-sm uppercase tracking-widest text-muted-foreground transition-colors hover:text-foreground"
              >
        ...
        <div className="flex flex-col justify-center">
          <div className="space-y-6 text-muted-foreground">
            <p className="text-lg leading-relaxed">
              ...
              <span className="font-medium text-foreground">Test Automation Engineer</span>
              {" with 7+ years of experience delivering high-quality, scalable automation frameworks. My expertise spans "}
              <span className="font-medium text-foreground">Web, API, and Performance Testing</span>
            ...
            <p className="text-lg leading-relaxed">
              ...
              <span className="font-medium text-foreground">Selenium Grid</span>
              {", "}
            ...
            <p className="text-lg leading-relaxed">
              ...
              {", "}
              <span className="font-medium text-foreground">TestNG</span>
              {", "}
              <span className="font-medium text-foreground">Maven</span>
